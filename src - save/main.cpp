...
#define BOARD_COMBO_AMG_I2C_ADDR    (0x29) ///< I2C address on breakout board (for Bosh BNO055)
...
const orsensor_bus_addresses bus_i2c_addr = {BOARD_COMBO_AMG_I2C_ADDR,0,BOARD_COMBO_BARO_THERM_I2C_ADDR};
const sensor_cap sensor_capability = AMT;
...
void setup() {
  ...
  sensesp_app = (&builder)
                    ...
                    ->set_wifi("4G-WIFI-FREETIME", "pazzagliawless")

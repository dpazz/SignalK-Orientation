...
ACC_ONLY              = 0b00000001,
MAG_ONLY              = 0b00000010,
GYRO_ONLY             = 0b00000100, 
THERM_ONLY            = 0b00001000,
BARO_ONLY             = 0b00010000,            
AMT                   = 0b00101011,
AMGT                  = 0b00101111,
BARO_THERM            = 0b00111000,
AMT_PLUS_BT           = 0b01011011,
AMGT_PLUS_BT          = 0b01011111

} sensor_cap;

typedef struct orsensor_bus_addresses {int8_t addr[3];} orsensor_bus_addresses;

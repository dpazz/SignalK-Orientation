...
int8_t Accel_Init(PhysicalSensor *sensor, SensorFusionGlobals *sfg);
int8_t Mag_Init(PhysicalSensor *sensor, SensorFusionGlobals *sfg);
int8_t Therm_Init(PhysicalSensor *sensor, SensorFusionGlobals *sfg);
...
int8_t Therm_Read(PhysicalSensor *sensor, SensorFusionGlobals *sfg);

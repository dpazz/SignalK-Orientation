...
//IMPORT SNIPPET from sensor_fusion/precisionAccelerometer.h
...
//end of IMPORT from sensor_fusion/precisionAccelerometer.h
...
#ifndef ACCEL_FIFO_DATA_AVAILABLE
#define ACCEL_FIFO_SIZE 0
#endif	
...
struct MagSensor
{
	...
	uint8_t iFIFOCount;			///< number of measurements read from FIFO
        uint16_t iFIFOExceeded;                 ///< Number of samples received in excess of software FIFO size
#ifndef MAG_FIFO_DATA_AVAILABLE
#define MAG_FIFO_SIZE 0
#endif			
...
struct GyroSensor
{
	...
	uint8_t iFIFOCount;			///< number of measurements read from FIFO
        uint16_t iFIFOExceeded;                 ///< Number of samples received in excess of software FIFO size
#ifndef GYRO_FIFO_DATA_AVAILABLE
#define GYRO_FIFO_SIZE 0
#endif	
